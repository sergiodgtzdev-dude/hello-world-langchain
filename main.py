...
def main():
    ...
    information = """
    Elon Reeve Musk (/ˈiːlɒn/ EE-lon; born June 28, 1971) is a businessman and entrepreneur known for his leadership of Tesla, SpaceX, Twitter, and xAI. Musk has been the wealthiest person in the world since 2021; as of January 2026, Forbes estimates his net worth to be around US$788 billion.
...
#Gives visibility of error logs against prompts (enforces strict formatting structure)
    summary_prompt_template = PromptTemplate(
        input_variables=["information"], template=summary_template
    )

#Temperature simbolizes how creative the resposne is (0 being more deterministic and producing the same results and 8 being super creative)
